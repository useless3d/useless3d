...
void ExampleScene1::load()
{
    ...
    stage.getCamera()->setLookAt(0.0f, 1.0f, 0.0f);
	...
	skinnedActor->getTransform().setTranslation(glm::vec3(0.0f, 1.0f, -2.0f));
	skinnedActor->getTransform().setRotation(180.0f, glm::vec3(0.0f, 1.0f, 0.0f));
