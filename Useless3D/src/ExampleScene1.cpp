...
void ExampleScene1::load()
{
	...
	stage.loadArmature("data/models/bin/characters/low_poly/armature.fbx"); // add actors to this stage, use default shader for all meshes in this file
    //stage.loadArmature("data/models/bin/characters/animation_test/armature.fbx"); // add actors to this stage, use default shader for all meshes in this file
